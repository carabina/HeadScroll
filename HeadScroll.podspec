Pod::Spec.new do |s|
  ...
  s.version  = '1.0.0'
  s.license  = 'MIT'
  s.summary  = 'A HeadScroll iOS and OS X test framework.'
  s.homepage = 'git@git.tisp.com:zhangwenjie/HeadScroll.git'
  s.authors  = { 'jack' => 'm@mattt.me' }
  s.source   = { :git => 'https://github.com/AFNetworking/AFNetworking.git', :tag => s.version, :submodules => true }
  s.requires_arc = true
  
  s.public_header_files = 'AFNetworking/AFNetworking.h'
  s.source_files = 'Head/HeadScroll.swift'
